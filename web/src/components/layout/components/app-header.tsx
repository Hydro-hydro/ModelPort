...
type AppHeaderProps = {
  /**
   * Custom navigation links kept for compatibility; the personal version
   * always uses its fixed top navigation.
   */
  navLinks?: TopNavLink[]
  /**
...
export function AppHeader({
  ...
  // The personal version always uses the fixed console/model-square links.
