...
export const STATIC_I18N_KEYS = [
  ...
  'Access Control',
  'Manage API tokens, model limits, and request access locally',
  ...
  'Usage Tracking',
  'Track model usage and request costs for this gateway',
  'Built for personal gateways',
  'focused on interoperability',

  // Optional capability settings
  'Optional Features',
  'System Tasks',
  'Run maintenance and background task workers.',
  'Media Tasks',
  'Enable video and other asynchronous media task adapters.',
  'Task Plugins',
  'Run task plugin adapters and the task API.',
  'Deployments',
  'Enable external model deployment management.',
  'Multi-node',
  'Enable node reporting and multi-instance coordination.',
  'Restart required',
